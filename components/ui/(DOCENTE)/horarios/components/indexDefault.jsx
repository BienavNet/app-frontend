...
//   const [comentariosdata, setComentarioData] = useState([]);
...
//                     {capitalizeFirstLetter(truncateText(i.nombre, 10))}{" "}
//                     {i.numero_salon}
//                   </ListItem.Title>
//                 </View>
//                 <View>
//                   <Text style={styles.itemP2}>{i.categoria}</Text>
//                 </View>
//               </View>
//               <View
//                 style={{
...
//               <View>
//                 <ListItem.Title>
//                   {capitalizeFirstLetter(i.nombre)} {i.numero_salon}
//                 </ListItem.Title>
//               </View>
//             </View>
//             <View
...
//               <View>
//                 <ListItem.Title>
//                   {capitalizeFirstLetter(i.categoria)}
//                 </ListItem.Title>
//               </View>
//               <View
//                 style={{
...
//               }}
//             >
//               <DateChip item={new Date(i.fecha).toLocaleDateString()} />

//               <StatusCircle item={i.estado} />
//             </View>
//           </BoxView>
//         </ListItem.Content>
//         <ListItem.Chevron />
